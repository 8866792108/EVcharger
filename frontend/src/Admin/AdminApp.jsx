...
import Sidebar from "../../../Admin-Panel/src/components/Sidebar"
import Dashboard from "../../../Admin-Panel/src/components/Dashboard/Dashboard"
import MapAdd from "../../../Admin-Panel/src/components/maps/MapAdd"
import Displaymap from "../../../Admin-Panel/src/components/maps/Displaymap"
import Updatemap from "../../../Admin-Panel/src/components/maps/Updatemap"
import PaymentManagement from "../../../Admin-Panel/src/components/payments/PaymentManagement"
import JoinWithUs from "../../../Admin-Panel/src/components/Messages/JoinWithUs"
import Feedback from "../../../Admin-Panel/src/components/Messages/Feedback"
            ...
            <div className="flex h-screen antialiased text-gray-900 bg-gradient-to-br from-gray-50 to-gray-100 dark:bg-dark dark:text-light">
                ...
                <div className="flex flex-col flex-1 h-[100vh] overflow-scroll">
                    <main className="flex-1 p-4">
                        ...
                        <Route path="/Admin/maps/add" element={<MapAdd />} />
                        <Route path="/Admin/maps/display" element={<Displaymap />} />
                        <Route path="/Admin/maps/update" element={<Updatemap />} />
                        <Route path="/Admin/payments" element={<PaymentManagement />} />
                        <Route path="/Admin/Join-requests" element={<JoinWithUs />} />
                        <Route path="/Admin/feedback" element={<Feedback />} />
                        <Route path='/Admin/edit-map/:id' element={<Updatemap />}
                            loader={async ({ params }) => {
                                console.log(params)
