    ...
    <div className="profile">
      ...
      <main className="md:pl-16 md:transition-all md:duration-300 md:data-[expanded=true]:pl-64">
        <div className=" max-w-screen-2xl mx-auto p-6">
          <div className="dark:bg-black dark:text-gray-200 rounded-xl shadow-sm overflow-hidden">
            {/* Profile Header */}
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  {userData.savedLocations.map(location => (
                    <div key={location.id} className=" dark:bg-black dark:text-gray-200 p-4 rounded-lg hover:bg-red-100 hover:text-red-500">
                ...
                <div className="space-y-4 md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    <button className="flex items-center gap-2 px-4 py-2 dark:bg-black rounded-lg hover:bg-red-100 hover:text-red-500">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 text-red-600 dark:bg-black rounded-lg hover:bg-red-100">
